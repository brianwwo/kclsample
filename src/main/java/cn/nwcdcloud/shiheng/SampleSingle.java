...
//        }
        ...
        String streamName = "shiheng-orders";
        String region = null;
        if (args.length > 1) {
            region = args[1];
        }
    ...
    private final static String BUCKET_NAME = "shiheng-poc";
    private final static String REGION = "cn-northwest-1";
    private static S3DropTimeExecutor s3DropTimeExecutor;
    ...
    private SampleSingle(String streamName, String region) {
        ...
        this.region = Region.of(ObjectUtils.firstNonNull(region, REGION));
        this.kinesisClient = KinesisClientUtil.createKinesisAsyncClient(KinesisAsyncClient.builder().region(this.region));
        this.s3DropTimeExecutor = new S3DropTimeExecutor(REGION, BUCKET_NAME);
    }
